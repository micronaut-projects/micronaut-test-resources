...
| https://mariadb.org/[MariaDB] | Yes | Yes | `mariadb` | `mariadb:11.8.6`
| https://www.mysql.com/[MySQL] | Yes | Yes | `mysql` | `container-registry.oracle.com/mysql/community-server:8.4.8`
...
| https://www.postgresql.org/[PostgreSQL] | Yes | Yes | `postgres` | `postgres:18.3`
| https://www.microsoft.com/sql-server[Microsoft SQL Server] | Yes | Yes | `mssql` | `mcr.microsoft.com/mssql/server:2022-CU24-ubuntu-22.04`
