...
* The default image (`redis:6.2.21`, or `grokzen/redis-cluster:6.2.14` in cluster mode) can be overwritten by setting the `test-resources.containers.redis.image-name` property.
