...
Micronaut Test Resources uses the underlying container's default https://www.testcontainers.org/features/startup_and_waits/[Testcontainers wait strategies] unless a provider documents a more specific default.
