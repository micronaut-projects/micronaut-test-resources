 ...
 */
public final class HibernateReactiveMariaDBComposeTestResourceProvider extends HibernateReactiveMariaDBTestResourceProvider implements ComposeAwareTestResourcesResolver {
    @Override
    public String getDisplayName() {
        return "Docker Compose MariaDB Hibernate Reactive";
    }
    ...
    protected Optional<String> resolveWithoutContainer(String propertyName,
        ...
        Optional<String> compose = ComposeDatabaseResolverSupport.resolveHibernateReactive(propertyName, properties, testResourcesConfig, ComposeDatabaseDescriptors.MARIADB);
