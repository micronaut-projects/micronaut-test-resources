 ...
 */
public final class HibernateReactiveMSSQLComposeTestResourceProvider extends HibernateReactiveMSSQLTestResourceProvider implements ComposeAwareTestResourcesResolver {
    @Override
    public String getDisplayName() {
        return "Docker Compose MSSQL Hibernate Reactive";
    }
    ...
    protected Optional<String> resolveWithoutContainer(String propertyName,
        ...
        Optional<String> compose = ComposeDatabaseResolverSupport.resolveHibernateReactive(propertyName, properties, testResourcesConfig, ComposeDatabaseDescriptors.MSSQL);
