 ...
 */
public final class HibernateReactiveMySQLComposeTestResourcesProvider extends AbstractComposeDatabaseTestResourcesProvider {
    private static final String SERVICE_TYPE = "mysql";

    public HibernateReactiveMySQLComposeTestResourcesProvider() {
