 ...
 */
public final class HibernateReactiveOracleFreeComposeTestResourceProvider extends HibernateReactiveOracleFreeTestResourceProvider implements ComposeAwareTestResourcesResolver {
    @Override
    public String getDisplayName() {
        return "Docker Compose Oracle Hibernate Reactive";
    }
