...
/**
 * Resolves Oracle XE Hibernate Reactive properties from Docker Compose services.
 */
public final class HibernateReactiveOracleXEComposeTestResourceProvider extends HibernateReactiveOracleXETestResourceProvider implements ComposeAwareTestResourcesResolver {
    @Override
    public String getDisplayName() {
        return "Docker Compose Oracle XE Hibernate Reactive";
    }
    ...
    protected Optional<String> resolveWithoutContainer(String propertyName,
        ...
        Optional<String> compose = ComposeDatabaseResolverSupport.resolveHibernateReactive(propertyName, properties, testResourcesConfig, ComposeDatabaseDescriptors.ORACLE);
