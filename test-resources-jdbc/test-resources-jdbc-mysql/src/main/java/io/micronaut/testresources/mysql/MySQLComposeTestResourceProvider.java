...
/**
 * Resolves MySQL properties from Docker Compose services.
 */
public final class MySQLComposeTestResourceProvider extends MySQLTestResourceProvider implements ComposeAwareTestResourcesResolver {
    @Override
    ...
    protected Optional<String> resolveWithoutContainer(String propertyName,
        ...
        return ComposeDatabaseResolverSupport.resolveJdbc(propertyName, properties, testResourcesConfig, ComposeDatabaseDescriptors.MYSQL);
    }
}
