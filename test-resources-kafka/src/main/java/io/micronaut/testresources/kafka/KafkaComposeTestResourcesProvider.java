 ...
 */
public final class KafkaComposeTestResourcesProvider extends AbstractComposeTestResourcesProvider {
    public KafkaComposeTestResourcesProvider() {
        super("kafka", Set.of("kafka", "redpanda"), 9092, List.of("kafka.bootstrap.servers"));
    }
