...
/**
 * Resolves OpenTelemetry properties from Docker Compose services.
 */
public final class OpenTelemetryComposeTestResourcesProvider extends AbstractComposeTestResourcesProvider {
    public OpenTelemetryComposeTestResourcesProvider() {
