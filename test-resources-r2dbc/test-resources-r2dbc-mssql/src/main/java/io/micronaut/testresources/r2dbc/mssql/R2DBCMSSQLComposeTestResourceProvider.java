 ...
 */
public final class R2DBCMSSQLComposeTestResourceProvider extends R2DBCMSSQLTestResourceProvider implements ComposeAwareTestResourcesResolver {
    @Override
    public String getDisplayName() {
        return "Docker Compose MSSQL R2DBC";
    }
    ...
    protected Optional<String> resolveWithoutContainer(String propertyName,
        ...
        Optional<String> compose = ComposeDatabaseResolverSupport.resolveR2dbc(propertyName, properties, testResourcesConfig, ComposeDatabaseDescriptors.MSSQL);
