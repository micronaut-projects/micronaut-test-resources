 ...
 */
public final class R2DBCMySQLComposeTestResourceProvider extends R2DBCMySQLTestResourceProvider implements ComposeAwareTestResourcesResolver {
    @Override
    public String getDisplayName() {
        return "Docker Compose MySQL R2DBC";
    }
    ...
    protected Optional<String> resolveWithoutContainer(String propertyName,
        ...
        Optional<String> compose = ComposeDatabaseResolverSupport.resolveR2dbc(propertyName, properties, testResourcesConfig, ComposeDatabaseDescriptors.MYSQL);
