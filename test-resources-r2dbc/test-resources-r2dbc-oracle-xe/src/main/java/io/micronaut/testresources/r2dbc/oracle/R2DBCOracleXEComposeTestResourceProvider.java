...
/**
 * Resolves Oracle XE R2DBC properties from Docker Compose services.
 */
public final class R2DBCOracleXEComposeTestResourceProvider extends R2DBCOracleXETestResourceProvider implements ComposeAwareTestResourcesResolver {
    @Override
    public String getDisplayName() {
        return "Docker Compose Oracle XE R2DBC";
    }
    ...
    protected Optional<String> resolveWithoutContainer(String propertyName,
        ...
        Optional<String> compose = ComposeDatabaseResolverSupport.resolveR2dbc(propertyName, properties, testResourcesConfig, ComposeDatabaseDescriptors.ORACLE);
