 ...
 */
public final class R2DBCOracleXEComposeTestResourcesProvider extends AbstractComposeDatabaseTestResourcesProvider {
    private static final String SERVICE_TYPE = "oracle";

    public R2DBCOracleXEComposeTestResourcesProvider() {
