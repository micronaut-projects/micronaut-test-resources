...
/**
 * Resolves Redis cluster properties from Docker Compose services.
 */
public final class RedisClusterComposeTestResourceProvider extends RedisClusterTestResourceProvider implements ComposeAwareTestResourcesResolver {
    private static final Logger LOG = LoggerFactory.getLogger(RedisClusterComposeTestResourceProvider.class);
    ...
    public String getDisplayName() {
        return "Docker Compose Redis Cluster";
    }
