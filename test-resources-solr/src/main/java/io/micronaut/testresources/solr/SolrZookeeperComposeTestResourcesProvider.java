...
/**
 * Resolves Solr ZooKeeper properties from Docker Compose services.
 */
public final class SolrZookeeperComposeTestResourcesProvider extends AbstractComposeTestResourcesProvider {
    public SolrZookeeperComposeTestResourcesProvider() {
